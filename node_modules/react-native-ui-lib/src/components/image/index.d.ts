...
import { ImageProps as RNImageProps, NativeSyntheticEvent, ImageErrorEventData } from 'react-native';
...
declare class Image extends PureComponent<Props, State> {
    ...
    renderImageWithContainer: () => JSX.Element;
...
} & ThemeComponent, any> & typeof Image;
