...
declare class Dialog extends Component<DialogProps, DialogState> {
    ...
    onDismiss: () => void;
    hideDialogView: () => void;
    renderPannableHeader: (directions: PanningDirections[]) => JSX.Element | undefined;
    ...
    renderDialogView: () => JSX.Element;
    renderDialogContainer: () => JSX.Element;
    render: () => JSX.Element;
}
declare const _default: React.ComponentClass<DialogProps & ThemeComponent, any> & typeof Dialog;
