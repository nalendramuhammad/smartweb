...
function Calendar(props) {
  ...
  const scrollToIndex = useCallback(date => {
  ...
  return <CalendarContext.Provider value={contextValue}>
      ...
      <FlashList
    // @ts-expect-error
    ref={flashListRef} estimatedItemSize={calendarWidth} data={MONTH_ITEMS} initialScrollIndex={initialMonthIndex.current} estimatedFirstItemOffset={0} renderItem={renderCalendarItem} horizontal pagingEnabled showsHorizontalScrollIndicator={false}
    // TODO: Consider moving this shared logic with Agenda to a hook
    onViewableItemsChanged={onViewableItemsChanged} onMomentumScrollBegin={onMomentumScrollBegin} onScrollBeginDrag={onScrollBeginDrag} />
      {children}
      <TodayButton />
