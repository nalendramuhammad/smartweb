...
function Agenda() {
  ...
  const renderEvent = useCallback(item => {
    return <View marginV-1 marginH-10 paddingH-10 height={50} style={{
      borderWidth: 1,
      ...
      justifyContent: 'center'
        ...
        <Text style={{}}>
          ...
          -{new Date(item.end).toLocaleString('en-GB', {
          hour12: false,
          hour: '2-digit',
          minute: '2-digit'
        })}
  ...
  const renderHeader = useCallback(item => {
    return <View marginB-1 paddingB-4 marginH-10 paddingH-10 height={50} bottom>
  ...
  return <FlashList ref={flashList} estimatedItemSize={52} data={data} keyExtractor={keyExtractor} renderItem={renderItem} getItemType={getItemType} onViewableItemsChanged={onViewableItemsChanged} onMomentumScrollBegin={onMomentumScrollBegin} onScrollBeginDrag={onScrollBeginDrag} initialScrollIndex={findClosestDateAfter(selectedDate.value)?.index ?? 0} />;
}
